...
**Test/evidence:** exact prompts, raw outputs, manual changes and tests (TODO).  
**TODO(each role):** Replace templates with complete exact prompt/raw/refinement records.  
**DoD:** Every AI-assisted change is explainable and independently checked.
