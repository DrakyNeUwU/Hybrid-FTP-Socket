...
compression) with streaming codecs, TYPE A/I-specific filler semantics and
SHA-256-preserving E2E verification.
...
broader network-performance measurements. Release acceptance still requires
Role B review of the extended START metadata and Role A screenshot embedding.
