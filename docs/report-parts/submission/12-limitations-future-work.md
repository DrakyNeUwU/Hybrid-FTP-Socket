...
| RDT wire-contract sign-off | Go-Back-N và START ACK/retry đã có test; B/C review completed | B, C review | So khớp header/state machine với `docs/api-contract.md` và ký review |
