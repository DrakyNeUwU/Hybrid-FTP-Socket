...
**Test/evidence:** links to failed/pending runs (TODO).  
**TODO(all):** Reconcile API, FIN/ACK, cancellation, endpoint and test dependency blockers.  
**DoD:** Every limitation has owner, impact and verification plan.
